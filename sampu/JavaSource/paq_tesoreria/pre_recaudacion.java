...
public class pre_recaudacion extends Pantalla{
	...
	public pre_recaudacion(){
		...
		tab_recaudacion.setColumnaSuma("total_fafac");
	...
	public void devolucion(){
		if(txt_total.getValue().toString()==""){
			utilitario.agregarMensajeInfo("No existe devolucion", "No existe un valor a cobrar por lo cual no se puede calacular el valor a devolver");
			return;	
		}
		double dou_valor_total=Double.parseDouble(txt_total.getValue().toString());
		double dou_valor_entregado=Double.parseDouble(txt_valor_entregado.getValue().toString());
	...
	public void calculoTotal(){
		...
		if(tab_recaudacion.getSeleccionados().length>0){
			for(int i=0;i<tab_recaudacion.getSeleccionados().length;i++){
				//System.out.println("  indice "+tab_recaudacion.getSeleccionados()[i].getIndice());
				valor_total +=Double.parseDouble(tab_recaudacion.getValor(tab_recaudacion.getSeleccionados()[i].getIndice(),"total_fafac"));
