		...
		if (rep_reporte.getReporteSelecionado().equals("Ficha Medica Empleado")){		
				...
				if (tab_ficha_medica.getTotalFilas()>0) {			
					if (rep_reporte.isVisible()){
						...
						rep_reporte.cerrar();		
						p_parametros.put("ide_safim",Integer.parseInt(tab_ficha_medica.getValor("IDE_SAFIM")));
...
/*	public void edad(){
		...
		int mes=Integer.parseInt((tab_ficha_medica.getColumna("MES_EDAD_SAFIM").toString()));
