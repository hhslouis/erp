...
public class pre_mayor_analitico extends Pantalla{
	...
	public pre_mayor_analitico() {
		...
		tab_tabla1.setSql(ser_contabilidad.getMayorAnalitico("1900-01-01", "1900-01-01", "-1"));	
		...
		tab_tabla1.setColumnaSuma("debe_codem,haber_codem");
	...
	public void imprimirMayorAnalitico(){
		...
		tab_tabla1.setSql(ser_contabilidad.getMayorAnalitico(cal_fecha_inicial.getFecha(), cal_fecha_final.getFecha(), seleccionados));
