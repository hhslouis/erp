...
public class pre_mayor_contvspre extends Pantalla{
	...
	public pre_mayor_contvspre() {
		...
		*/	
			...
			tab_mayor_cont_pre.setSql("select 1 as ide_codem, 2 as mov_fecha_comov,3 as cue_codigo_cocac,4 as cue_descripcion_cocac,5 as ide_comov,6 as debe_codem,7 as haber_codem,8 as devengado_prmen,9 as codigo_clasificador_prcla,10 as descripcion_clasificador_prcla where 1=0");
			tab_mayor_cont_pre.setCampoPrimaria("ide_codem");
			tab_mayor_cont_pre.setColumnaSuma("debe_codem,haber_codem,devengado_prmen");
			...
			tab_mayor_pre_cont.setSql("select 1 as ide_codem, 2 as mov_fecha_comov,3 as cue_codigo_cocac,4 as cue_descripcion_cocac,5 as ide_comov,6 as debe_codem,7 as haber_codem,8 as devengado_prmen,9 as codigo_clasificador_prcla,10 as descripcion_clasificador_prcla where 1=0");
			tab_mayor_pre_cont.setCampoPrimaria("ide_codem");
			tab_mayor_pre_cont.setColumnaSuma("debe_codem,haber_codem,devengado_prmen");
	...
	public String sqlGeneraMayor(String numero_tabla,String tipo_cuenta,String fechaini,String fechafin,String cuenta,String partida){
		...
		String cabecera_sql="select a.ide_codem,mov_fecha_comov,cue_codigo_cocac,cue_descripcion_cocac,ide_comov,debe_codem,haber_codem,devengado_prmen,codigo_clasificador_prcla,descripcion_clasificador_prcla from (";
		...
		String sql_presupuesto_gasto="select a.ide_prpoa,c.ide_prcla,devengado_prmen,codigo_clasificador_prcla,descripcion_clasificador_prcla,ide_codem"
				+" from pre_anual a, pre_mensual b, pre_poa c,pre_clasificador d"
				+" where a.ide_pranu = b.ide_pranu  and a.ide_prpoa = c.ide_prpoa and c.ide_prcla = d.ide_prcla";

		String sql_presupuesto_ingreso="select a.ide_prcla,devengado_prmen,codigo_clasificador_prcla,descripcion_clasificador_prcla,ide_codem"
				+" from pre_anual a, pre_mensual b,pre_clasificador d"
				+" where a.ide_pranu = b.ide_pranu   and a.ide_prcla = d.ide_prcla";
