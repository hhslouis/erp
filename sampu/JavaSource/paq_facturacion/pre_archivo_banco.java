...
+" detalle_bogrm,replace(total_fafac||'','.','') as tot_sin_punto, ( case when ide_gttdi = 1  then 'P' when ide_gttdi= 2 then 'R' when ide_gttdi= 3 then 'C' end) as doc_identidad,round(valor_iva_fafac,2) as nuevo_iva"
