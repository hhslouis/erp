...
public class pre__consulta_poa_contratacion extends Pantalla{

    private Tabla tab_pre_funcion_programa = new Tabla();
	...
	public pre__consulta_poa_contratacion(){
...
//pre_funcion_programa
		

		tab_pre_funcion_programa.setId("tab_pre_funcion_programa");   
		tab_pre_funcion_programa.setHeader("FUNCION PROGRAMA");		
		tab_pre_funcion_programa.setTabla("pre_funcion_programa","ide_prfup",1);
		tab_pre_funcion_programa.setCondicion("ide_prnfp=5");  
		tab_pre_funcion_programa.getColumna("ide_prsua").setCombo("pre_sub_actividad","ide_prsua","detalle_prsua","");

		tab_pre_funcion_programa.getColumna("ide_prnfp").setCombo("pre_nivel_funcion_programa","ide_prnfp","detalle_prnfp","");

		tab_pre_funcion_programa.getColumna("pre_ide_prfup").setCombo("pre_funcion_programa","ide_prfup","detalle_prfup","");
		tab_pre_funcion_programa.getColumna("pre_ide_prfup").setAutoCompletar();
		//tab_pre_funcion_programa.setTipoFormulario(true);
		tab_pre_funcion_programa.getGrid().setColumns(4);
		tab_pre_funcion_programa.agregarRelacion(tab_poa);
		tab_pre_funcion_programa.onSelect("Actualizar");
		tab_pre_funcion_programa.dibujar();
		PanelTabla pat_pre_poa=new PanelTabla();
		pat_pre_poa.setPanelTabla(tab_pre_funcion_programa);
		...
		tab_poa.agregarRelacion(tab_funcion_programa);
		//agraga relacion para los tabuladores
		tab_poa.agregarRelacion(tab_mes);
		...
		tab_mes.setCondicion("ide_prpoa="+tab_poa.getValorSeleccionado());
	...
	//	arb_arbol.setArbol("pre_funcion_programa", "ide_prfup", "codigo_prfup ||' '||detalle_prfup", "pre_ide_prfup");
		...
		div_division.dividir2(pat_pre_poa, div3, "40%", "H");  //arbol y div3
...
///// para subir vaslores de un tabla a otra Financiamiento 
	...
	public void Actualizar(SelectEvent evt) {
	
		tab_pre_funcion_programa.seleccionarFila(evt);
		tab_poa.setCondicion("ide_prfup="+tab_pre_funcion_programa.getValorSeleccionado());
		tab_poa.ejecutarSql();		
		tab_poa.getColumna("IDE_PRFUP").setValorDefecto(tab_funcion_programa.getValorSeleccionado());
...
/////dialogo para reporte
	...
	public void filtrarAnio(){
		...
		if(com_anio.getValue()!=null){
			tab_pre_funcion_programa.setCondicion("ide_prfup in (select ide_prfup from cont_vigente where not ide_prfup is null and ide_geani="+com_anio.getValue()+")");		
			tab_poa.getColumna("ide_geani").setValorDefecto(com_anio.getValue().toString());
		}
		else{
			tab_pre_funcion_programa.setCondicion("ide_prfup in (select ide_prfup from cont_vigente where not ide_prfup is null and ide_geani=-1 )");
		}
		tab_pre_funcion_programa.ejecutarSql();		
		
		utilitario.addUpdate("tab_pre_funcion_programa");
	...
	public Tabla getTab_pre_funcion_programa() {
		return tab_pre_funcion_programa;
	}

	public void setTab_pre_funcion_programa(Tabla tab_pre_funcion_programa) {
		this.tab_pre_funcion_programa = tab_pre_funcion_programa;
	}
