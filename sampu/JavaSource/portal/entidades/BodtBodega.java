...
@NamedQueries({
    ...
    @NamedQuery(name = "BodtBodega.findByExistenciaAnteriorBodod", query = "SELECT b FROM BodtBodega b WHERE b.existenciaAnteriorBodod = :existenciaAnteriorBodod"),
...
public class BodtBodega implements Serializable {
    ...
    @Column(name = "existencia_anterior_bodod", precision = 10, scale = 2)
    private BigDecimal existenciaAnteriorBodod;
    ...
    public BigDecimal getExistenciaAnteriorBodod() {
        return existenciaAnteriorBodod;
    }

    public void setExistenciaAnteriorBodod(BigDecimal existenciaAnteriorBodod) {
        this.existenciaAnteriorBodod = existenciaAnteriorBodod;
    }
